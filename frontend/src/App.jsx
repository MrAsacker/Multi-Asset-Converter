...
//   // Ref for focusing the input field when user clicks
//   const inputRef = useRef(null);

//   // Function to fetch and update the exchange rate
//   const updateRate = async () => {
//     // Don't do anything if currencies aren't selected
//     if (!fromAsset?.code || !toAsset?.code) return;
    
//     setLoading(true);
//     try {
//       // Fetch rates from our API
//       const rates = await fetchRates(fromAsset.code);
      
//       // If we got the rate for the target currency, update it
...
//   // Run once when component first loads to get initial rates
//   useEffect(() => {
//     updateRate();
//   }, []);

//   // Handle user typing in the amount field
...
//   // Increase or decrease the amount by clicking +/- buttons
//   const adjustAmount = (val) => {
//     setAmount((prev) => {
//       const current = Number(prev) || 0;
//       // Don't allow negative amounts, add or subtract based on val parameter
//       return Math.max(0, current + val).toString();
//     });
//   };

//   // Prevent scientific notation (e.g., 1e5) in number inputs
//   const blockInvalidChar = (e) => ['e', 'E', '+', '-'].includes(e.key) && e.preventDefault();
  
//   // Focus the input when user clicks anywhere on the container
//   const handleContainerClick = () => inputRef.current?.focus();

//   // Format numbers for display (2 decimals for fiat, 6 for crypto, scientific notation for large numbers)
...
//   // Calculate the converted amount (amount × exchange rate)
...
//         {/* Main converter form with all input fields */}
//         <ConverterForm
//           amount={amount}
//           fromAsset={fromAsset}
//           toAsset={toAsset}
...
//           onConvert={updateRate} // Only calls when button clicked
